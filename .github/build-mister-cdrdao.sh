...
arm-none-linux-gnueabihf-strip --strip-all $STARTDIR/Scripts/.config/mister-cdrdao/cdrdao
arm-none-linux-gnueabihf-strip --strip-all $STARTDIR/Scripts/.config/mister-cdrdao/toc2cue
file $STARTDIR/Scripts/.config/mister-cdrdao/cdrdao $STARTDIR/Scripts/.config/mister-cdrdao/toc2cue
